...
class NameEdit extends Component {
    ...
    render() {
        ...
        */
        return (
            <div className={this.props.nameEditView ? css(styles.mainArea) : css(styles.mainArea, styles.editorHide)}>
                <section className={css(styles.modal)} >
                    <h3 className={css(styles.textRedo, styles.marginGapTop)}>Change Name of Product</h3>
                    <h5 className={css(styles.textRedo)}>Current Name: </h5>
                    <h6 className={css(styles.textRedo)}>{this.props.productName}</h6>
                    <input type='text'
                        className={css(styles.inputBoxStyled)}
                        placeholder='Product Name'
                        value={this.state.nameInputBox}
                        onChange={(e) => { this.handleNameBoxChange(e.target.value) }} />
